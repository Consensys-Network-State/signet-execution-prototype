...
local agreementDoc = TestUtils.loadInputDoc(inputDir .. "/grant-simple.wrapped.json")
local grantorInput = TestUtils.loadInputDoc(inputDir .. "/grant-simple.grantor-input.wrapped.json")
local recipientInput = TestUtils.loadInputDoc(inputDir .. "/grant-simple.recipient-input.wrapped.json")
local grantorAccept = TestUtils.loadInputDoc(inputDir .. "/grant-simple.grantor-accept.wrapped.json")
local grantorReject = TestUtils.loadInputDoc(inputDir .. "/grant-simple.grantor-reject.wrapped.json")
local workSubmission = TestUtils.loadInputDoc(inputDir .. "/grant-simple.work-submission.wrapped.json")
local workAccept = TestUtils.loadInputDoc(inputDir .. "/grant-simple.work-accept.wrapped.json")
local workReject = TestUtils.loadInputDoc(inputDir .. "/grant-simple.work-reject.wrapped.json")
local agreementReject = TestUtils.loadInputDoc(inputDir .. "/grant-simple.agreement-reject.wrapped.json")
local txProof = TestUtils.loadInputDoc(inputDir .. "/grant-simple.grantor-tx-proof.wrapped.json")
