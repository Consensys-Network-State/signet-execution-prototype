...
local grantorInput = TestUtils.loadInputDoc("./tests/grant-with-tx/grant-with-tx.grantor-input.wrapped.json")
local recipientInput = TestUtils.loadInputDoc("./tests/grant-with-tx/grant-with-tx.recipient-input.wrapped.json")
local grantorAccept = TestUtils.loadInputDoc("./tests/grant-with-tx/grant-with-tx.grantor-accept.wrapped.json")
local grantorReject = TestUtils.loadInputDoc("./tests/grant-with-tx/grant-with-tx.grantor-reject.wrapped.json")
...
local workReject = TestUtils.loadInputDoc("./tests/grant-with-tx/grant-with-tx.work-reject.wrapped.json")
local agreementReject = TestUtils.loadInputDoc("./tests/grant-with-tx/grant-with-tx.agreement-reject.wrapped.json")
local txProof = TestUtils.loadInputDoc("./tests/grant-with-tx/grant-with-tx.grantor-tx-proof.wrapped.json")
